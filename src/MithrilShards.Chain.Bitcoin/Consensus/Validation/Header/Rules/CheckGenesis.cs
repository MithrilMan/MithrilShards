...
{
   /// <summary>
   /// Checks if the header is a genesis header and in case verify its correctness.
   /// </summary>
   /// <seealso cref="MithrilShards.Chain.Bitcoin.Consensus.Validation.Header.HeaderValidationRuleBase" />
   public class CheckGenesis : HeaderValidationRuleBase
   {
      public CheckGenesis(ILogger<CheckGenesis> logger) : base(logger) { }
