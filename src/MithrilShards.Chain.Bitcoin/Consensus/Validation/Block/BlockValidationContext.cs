...
namespace MithrilShards.Chain.Bitcoin.Consensus.Validation.Block
{
   public class BlockValidationContext : ValidationContext, IBlockValidationContext
   {
      ...
      public BlockValidationContext(ILogger logger, Protocol.Types.Block block, bool isInInitialBlockDownloadState, IChainState chainState) : base(logger, isInInitialBlockDownloadState, chainState)
      {
         this.Block = block;
      }
   }
