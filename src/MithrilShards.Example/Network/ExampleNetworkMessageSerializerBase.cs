...
{
   /// <summary>
   /// The only reason to have this message serializer instead of using directly the <see cref="MithrilShards.Core.Network.Protocol.Serialization.NetworkMessageSerializerBase{TMessageType, TPeerContext}" /> is because we want to expose our <see cref="IPeerContext" />
